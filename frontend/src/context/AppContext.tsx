...
const translations: Record<Language, Record<string, string>> = {
  ID: {
    ...
    'history.empty_desc': 'Lakukan pengiriman atau klaim penerimaan untuk melihat riwayat.',
    ...
    'tx.type_claim': 'Klaim Penerimaan',
    ...
    'receipt.title': 'Cek & Cairkan Penerimaan',
    'receipt.step1_title': 'Masukkan Kode Tiket Klaim',
    'receipt.step1_desc': 'Pengirim memberikan Kode Tiket unik.',
    'receipt.label_code': 'Kode Tiket Penerimaan',
    'receipt.btn_search': 'Periksa Kode Tiket',
    'receipt.step2_title': 'Dana Ditemukan!',
    'receipt.sender_label': 'Pengirim:',
    'receipt.amount_label': 'Jumlah Kiriman:',
    'receipt.rate_label': 'Kurs Pencairan:',
    'receipt.total_idr_label': 'Total Rupiah Diterima:',
    'receipt.pin_label': 'Masukkan PIN Pengaman (4 Angka)',
    'receipt.pin_desc': 'Masukkan PIN dari pengirim.',
    'receipt.btn_claim': 'Cairkan ke Saldo Rupiah',
    'receipt.step3_title': 'Pencairan Sukses!',
    'receipt.step3_desc': 'Dana telah dicairkan ke saldo Rupiah Anda.',
    'receipt.btn_back_home': 'Kembali ke Beranda',
    ...
    'send.step2_method_ticket': 'Tiket Klaim',
    'send.step2_method_ticket_desc': 'Dana terkunci, buat Kode Tiket untuk dicairkan.',
    ...
    'send.step2_pin_label': 'Buat PIN Pengaman Tiket (4 Angka)',
    'send.step2_pin_desc': 'PIN untuk keamanan pencairan.',
    'send.step2_pin_placeholder': 'Contoh: 1234 (Otomatis jika kosong)',
    ...
    'send.step3_method_ticket': 'Tiket Klaim (Kode Unik)',
    ...
    'send.step3_disclaimer_ticket': 'Sistem akan mengunci dana di escrow Stellar Blockchain.',
    ...
    'send.step5_ticket_label': 'KODE TIKET KLAIM KELUARGA',
    'send.step5_pin_label': 'PIN PENGAMAN KLAIM',
    'send.step5_desc': 'Bagikan Kode Tiket & PIN ke keluarga Anda.',
  ...
  EN: {
    ...
    'history.empty_desc': 'Send remittance or claim to see history.',
    ...
    'receipt.title': 'Check & Claim Transfer',
    'receipt.step1_title': 'Enter Claim Ticket Code',
    'receipt.step1_desc': 'The sender will provide a unique Ticket Code.',
    'receipt.label_code': 'Claim Ticket Code',
    'receipt.btn_search': 'Check Ticket Code',
    'receipt.step2_title': 'Funds Found!',
    'receipt.sender_label': 'Sender:',
    'receipt.amount_label': 'Remittance Amount:',
    'receipt.rate_label': 'Disbursement Rate:',
    'receipt.total_idr_label': 'Total Rupiah Received:',
    'receipt.pin_label': 'Enter Secure PIN (4 Digits)',
    'receipt.pin_desc': 'Enter the security PIN from sender.',
    'receipt.btn_claim': 'Disburse to Rupiah Balance',
    'receipt.step3_title': 'Claim Successful!',
    'receipt.step3_desc': 'Funds have been credited to your Rupiah balance.',
    'receipt.btn_back_home': 'Back to Home',
    ...
    'send.step2_method_ticket': 'Claim Ticket',
    'send.step2_method_ticket_desc': 'Funds locked, generate Ticket Code for disbursement.',
    ...
    'send.step2_pin_label': 'Create Ticket PIN (4 Digits)',
    'send.step2_pin_desc': 'PIN for security.',
    'send.step2_pin_placeholder': 'e.g., 1234 (Auto if empty)',
    ...
    'send.step3_method_ticket': 'Claim Ticket (Unique Code)',
    ...
    'send.step3_disclaimer_ticket': 'System will lock funds in Stellar Blockchain escrow.',
    ...
    'send.step5_ticket_label': 'FAMILY CLAIM TICKET CODE',
    'send.step5_pin_label': 'CLAIM SECURITY PIN',
    'send.step5_desc': 'Share Ticket Code & PIN with your family.',
