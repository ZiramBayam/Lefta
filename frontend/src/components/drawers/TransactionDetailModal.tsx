...
import { X, ArrowUpRight, ArrowDownLeft, Layers, Check, Copy } from 'lucide-react';
          ...
          >
            ...
            <div className="p-5 flex flex-col gap-4">
              ...
              <button
                onClick={() => {
                  alert(language === 'ID'
                    ? `Meluncur ke penjelajah blockchain Stellar untuk memverifikasi Hash: ${selectedTx.txHash}`
                    : `Launching Stellar blockchain explorer to verify Hash: ${selectedTx.txHash}`);
                }}
